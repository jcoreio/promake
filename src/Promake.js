...
type Prerequisites = Array<string | BasicResource | Rule> | string | BasicResource | Rule
...
type HashPrerequisites = Array<string | BasicHashResource | Rule> | string | BasicHashResource | Rule
...
class Promake {
  ...
  _normalizeResource: (resource: any) => Resource = (resource: any): Resource => {
  ...
  _normalizePrerequisite: (resource: any) => Array<Resource> | Resource = (resource: any): Array<Resource> | Resource => {
    if (resource instanceof Rule) return resource.targets
    return this._normalizeResource(resource)
  }

  _normalizeResources: (resources: any) => Array<Resource> = (resources: any): Array<Resource> => {
  ...
  _normalizePrerequisites: (prerequisites: any) => Array<Resource> = (prerequisites: any): Array<Resource> => {
  ...
  _normalizeHashPrerequisites: (prerequisites: any) => Array<Resource> = (prerequisites: any): Array<Resource> => {
  ...
  _make: (resource: any, context: ExecutionContext) => Promise<?number> = async (resource: any, context: ExecutionContext): Promise<?number> => {
  ...
  make: (target: any, context?: ExecutionContext) => Promise<void> = async (target: any, context?: ExecutionContext = new ExecutionContext()): Promise<void> => {
    if (typeof target === 'string') target = this._normalizeName(target)
    await this._make(target, context)
  }

  log: (verbosity: VerbosityLevel, ...args: any) => void = (verbosity: VerbosityLevel, ...args: any) => {
    if (this.verbosity >= verbosity) console.error(chalk.bold('[promake]'), ...args) // eslint-disable-line no-console
  }

  logStream: (verbosity: VerbosityLevel, stream: Readable) => void = (verbosity: VerbosityLevel, stream: Readable) => {
  ...
  exec: (command: string, options?: child_process$execOpts) => ChildProcess = (command: string, options?: child_process$execOpts = {}): ChildProcess => {
  ...
  spawn: (command: string, argsOrOptions?: Array<string> | child_process$spawnOpts, options?: child_process$spawnOpts) => ChildProcess = (command: string, argsOrOptions?: Array<string> | child_process$spawnOpts, options?: child_process$spawnOpts): ChildProcess => {
  ...
  rule: (
    & ((targets: Targets, recipe?: (rule: Rule) => any, options?: {runAtLeastOnce?: boolean}) => Rule)
    & ((targets: Targets, prerequisites?: any, recipe?: (rule: Rule) => any, options?: {runAtLeastOnce?: boolean}) => Rule)
  ) = (targets: Targets, prerequisites?: any, recipe?: any, options?: any): Rule => {
  ...
  hashRule: (
    & ((algorithm: string, target: string | FileResource, prerequisites?: any, recipe?: (rule: Rule) => any, options?: {runAtLeastOnce?: boolean}) => Rule)
    & ((algorithm: string, target: string | FileResource, recipe?: (rule: Rule) => any, options?: {runAtLeastOnce?: boolean}) => Rule)
  ) = (algorithm: string, target: string | FileResource, prerequisites?: any, recipe?: any, options?: any): Rule => {
  ...
  task: (
    & ((name: string, prerequisites?: any, recipe?: (rule: Rule) => any) => Rule)
    & ((name: string, recipe?: (rule: Rule) => any) => Rule)
  ) = (name: string, prerequisites?: any, recipe?: any): Rule => {
...
`)
  ...
  cli: (argv?: Array<string>, options?: CliOptions) => Promise<any> = async (argv: Array<string> = process.argv, options?: CliOptions = {}): Promise<any> => {
